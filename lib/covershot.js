...
var writeCoverage = exports.writeCoverage = function (outputDir) {
  if (coverageWritten) {
    return;
  }
  ...
  var dir = path.join(outputDir ? outputDir : exports.outputDir, 'data');
...
exports.generate = require('./cli').run;
